...
class AddCar extends Component {
      ...
      onSelectPic(event){
        ...
        reader.onload = function(e) {
          ...
          //console.log(base64)
          car.picture = base64;
          document.getElementById("imageContents").innerHTML = '<p><img width="100%" src="'+reader.result+'"/></p>';
        }
        this.setState({
          car
        })
            ...
            return (
              <div>
                    ...
                    <div className = "addcarBox">
                            ...
                            <Icon name = 'add circle'/>Add Your Car!
                            </Header>
                            <Form size='large' onSubmit={this.onSubmit}>
                              <div className = "block">
                                <Form.Field>
                                  <label>Brand: </label>
                                  <input placeholder='Your Car Brand' defaultValue = {this.state.car.brand} onChange={this.onChangeBrand} required />
                                </Form.Field>
                              </div>
                              <div className = "block">
                                <Form.Field >
                                <label>VID: </label>
                                <input placeholder='Your Car VID' defaultValue = {this.state.car.VID} onChange={this.onChangeVID} required/>
                                </Form.Field>
                              </div>
                              <div className = "block">
                              <Form.Field >
                                  <label>Capacity:</label>
                                  <Form.Select options={options} placeholder='Capacity' onChange={this.onChangeCapacity} required />
                              </Form.Field >
                              </div>
                              <div className = "block">
                              <Form.Field >
                                  <label>Description: </label>
                                  <Form.TextArea  placeholder='Tell us more about your car...'  defaultValue = {this.state.car.description} onChange={this.onChangeDes}/>
                              </Form.Field >
                              </div>
