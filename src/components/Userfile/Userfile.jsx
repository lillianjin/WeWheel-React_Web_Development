...
class Userfile extends Component {
  ...
  clickposts = () => {
    ...
    for (var i = 0; i < idlist.length; i++) {
      axios
        .get("http://54.161.49.214:4000/api/post/" + idlist[i])
        .then(response => {
          //   console.log(response);
  ...
  clickmycars = () => {
    ...
    for (var i = 0; i < idlist.length; i++) {
      axios
        .get("http://54.161.49.214:4000/api/car/" + idlist[i])
        .then(response => {
          //   console.log(response);
          //    cur_json: { item: response.data.data }
          // console.log(this.state.user.LikedCars)
  ...
  deletePost(e, card, username) {
    ...
    axios
      .delete("http://54.161.49.214:4000/api/post/" + card._id, {
      ...
      .then(response => {
        ...
        for (var i = 0; i < this.state.postinfo.length; i++) {
          if (response.data.data.CarId === this.state.postinfo[i].CarId) {
            ...
            this.state.user.posts.splice(
              this.state.user.posts.indexOf(card._id),
              1
            );
            break;
          }
  ...
  deletelikedcars(e, card, username) {
    ...
    axios
      .post("http://54.161.49.214:4000/api/favorite/delete", {
        userId: cur_id,
        carId: card._id
      })
      ...
      .then(response => {
        ...
        for (var i = 0; i < this.state.likedcarsinfo.length; i++) {
          if (response.data.data.CarId === this.state.likedcarsinfo[i].CarId) {
            ...
            this.state.user.LikedCars.splice(
              this.state.user.LikedCars.indexOf(card._id),
              1
            );
            break;
          }
  ...
  render() {
    ...
    const myposts = postinfo.map((card, i) => {
      return (
        <div
          className="ui card"
          style={{ width: "100%", height: "auto", left: "0", top: "0 vw" }}
          key={"mypost" + i}
        >
          <div
            className="content"
            style={{ padding: "0", backgroundColor: "#fdfdf6" }}
          >
            <div className="ui items">
              <div className="item">
                ...
                <div
                  className="content"
                  style={{ padding: "2vw", marginLeft: "2vw" }}
                >
                  <div
                    className="header"
                    style={{ margin: "0", fontSize: "2vw", paddingLeft: "3vw" }}
                  >
                    {card.Car.Brand}
                  </div>
                  <div
                  ...
                  >
                    ...
                    <Button
                      ...
                      basic
                      onClick={e =>
                        this.deletePost(e, card, this.state.user.username)
                      }
                      name={card}
                    >
                ...
                >
                  ...
                  >
                    <Button
                      ...
                      basic
                      onClick={e =>
                        this.deletelikedcars(e, card, this.state.user.username)
                      }
                      name={card}
                    >
                      <Icon name="minus square outline" />
            ...
            <div class="innerwrap">
              ...
              >
                <div style={{ height: "100%" }}>
                  <div
                    class="row grid clearfix"
                    style={{ width: "100%", paddingBottom: "2vw", margin: "0" }}
                  >
                    ...
                    >
                      <div class="grid clearfix">
                        ...
                        >
                          ...
                          >
                            {this.state.user.MyCars.length}
                          </h1>
                          <span style={{ color: "#053f5e" }}>My Cars</span>
                        </div>
                        ...
                        >
                          ...
                          >
                            {this.state.user.RentedCars.length}
                          </h1>

                          <span style={{ color: "#053f5e" }}>Rented Cars</span>
                        </div>
                        <div
                          class="col3"
                          style={{
                        ...
                        >
                          ...
                          >
                            {this.state.user.LikedCars.length}
                          </h1>

                          <span style={{ color: "#053f5e" }}>My Likes</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <ul class="row2tab clearfix" style={{ width: "100%" }}>
                      <li id="b1" onClick={this.clickposts}>
                        <i class="fa fa-list-alt" /> My Posts
                      </li>
                      <li id="b2" onClick={this.clickmycars}>
                        <i class="fa fa-car" /> My Cars
                      </li>
                      <li id="b3" onClick={this.clickmylikes}>
                        <i class="fa fa-heart" /> My Likes
                      </li>
                      <li id="b4" onClick={this.clickrentedcars}>
                        <i class="fa fa-car" /> Rented Cars
                      </li>

                      <a href="#/addcar">
                        {" "}
                        <li id="b5">
                          <i class="fa fa-plus" /> Add Car
                        </li>
                      </a>
                      <a href="#/addpost">
                        <li id="b5">
                          <i class="fa fa-bullhorn" /> Add Post
                        </li>
                      </a>
                    </ul>
                  </div>
              ...
              <section
                class="section2 clearfix"
                style={{ overflow: "auto", postion: "fixed" }}
              >
